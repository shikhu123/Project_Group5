    ...
    var c = { E: m.PI, m: m.max, j: m.min, Q: m.ceil, R: m.floor, H: m.abs, pb: m.sin, bc: m.cos, Id: m.tan, Zf: m.atan, fc: m.sqrt, v: m.pow, Md: m.random, $Round: m.round },
        g = (i.$Jease$ = {
            ...
            $InOutElastic: function (a) {
                ...
                var b = 0.45,
                    d = 0.1125;
                return (a *= 2) < 1 ? -0.5 * c.v(2, 10 * (a -= 1)) * c.pb(((a - d) * 2 * c.E) / b) : c.v(2, -10 * (a -= 1)) * c.pb(((a - d) * 2 * c.E) / b) * 0.5 + 1;
            },
            $InBack: function (a) {
                var b = 1.70158;
                return a * a * ((b + 1) * a - b);
    ...
    var n = { af: "data-scale", Eb: "data-autocenter", Lc: "data-nofreeze", ee: "data-nodrag" },
        ...
        s = (i.$JssorSlideshowFormations$ = new (function () {
            ...
            h.$FormationCircle = function (d) {
                for (var e = d.$Cols || 1, f = d.$Rows || 1, h = [], a, i = e / 2 - 0.5, j = f / 2 - 0.5, b = 0; b < e; b++) for (a = 0; a < f; a++) g(h, c.$Round(c.fc(c.v(b - i, 2) + c.v(a - j, 2))), [a, b]);
                return h;
            };
            h.$FormationCross = function (d) {
                for (var e = d.$Cols || 1, f = d.$Rows || 1, h = [], a, i = e / 2 - 0.5, j = f / 2 - 0.5, b = 0; b < e; b++) for (a = 0; a < f; a++) g(h, c.$Round(c.j(c.H(b - i), c.H(a - j))), [a, b]);
                return h;
            };
            h.$FormationRectangleCross = function (f) {
                for (var h = f.$Cols || 1, i = f.$Rows || 1, j = [], a, d = h / 2 - 0.5, e = i / 2 - 0.5, k = c.m(d, e) + 1, b = 0; b < h; b++) for (a = 0; a < i; a++) g(j, c.$Round(k - c.m(d - c.H(b - d), e - c.H(a - e))) - 1, [a, b]);
                return j;
            };
        })());
    i.$JssorSlideshowRunner$ = function (m, r, p, u, z, A) {
        ...
        function j(h, e, f) {
            ...
            a.Se = function (c, b) {
                ...
                if (!a.tc[f]) {
                    a.tc[f] = { I: c, G: b };
                    for (var d = 0; d < a.$Cols; d++) for (var e = 0; e < a.$Rows; e++) a.tc[f][e + "," + d] = { $Top: e * b, $Right: d * c + c, $Bottom: e * b + b, $Left: d * c };
                }
                return a.tc[f];
            };
            if (a.$Brother) {
